...
def initializeAllHardware():
    ...
    res['X_ENC'] = RotaryEncoder(*X_ENCODER_PINS, max_steps=0)
    res['Y_ENC'] = RotaryEncoder(*Y_ENCODER_PINS, max_steps=0)
    # res['Z_ENC'] = RotaryEncoder(**Z_ENCODER_PINS, max_steps=0)
